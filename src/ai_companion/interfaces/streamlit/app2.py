...
st.markdown("""
Welcome to the SQL Database and Visualization Agent. This AI agent is designed to help you query your SQL database and return data frames and visualize the data that you can interactively inspect and download.
""")
...
with st.expander("Example Questions", expanded=False):
    st.write(
        ...
        - What are the first 10 rows in the table?
        - Show the first 100 days of Revenue sorted by date and plot.
        """
    )
