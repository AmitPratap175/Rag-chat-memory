...
D
89%
[](https://cracku.in/51-two-alcohol-solutions-a-and-b-are-mixed-in-the-pro-x-cat-2020-slot-3)
Solution   
...
D
1
[](https://cracku.in/52-a-batsman-played-n-2-innings-and-got-out-on-all-oc-x-cat-2020-slot-3)
Solution   

Given, sum of scores in n matches+38+15n+2=29\frac{\text{sum of scores in n matches+38+15}}{n+2}=29n+2sum of scores in n matches+38+15​=29
Given, sum of scores in n matchesn=30\frac{\text{sum of scores in n matches}}{n}=30nsum of scores in n matches​=30
=> 30n + 53 = 29(n+2) => n=5
...
Let m and n be positive integers, If x2+mx+2n=0x^{2}+mx+2n=0x2+mx+2n=0 and x2+2nx+m=0x^{2}+2nx+m=0x2+2nx+m=0 have real roots, then the smallest possible value of m+nm+nm+n is
A
7
B
6
...
D
5
[](https://cracku.in/53-let-m-and-n-be-positive-integers-if-x2mx2n0-and-x2-x-cat-2020-slot-3)
Solution   

To have real roots the discriminant should be greater than or equal to 0.   

So, m2−8n≥0&4n2−4m≥0m^2-8n\ge0\ \&\ 4n^2-4m\ge0m2−8n≥0&4n2−4m≥0
=> m2≥8n&n2≥mm^2\ge8n\ \&\ n^2\ge mm2≥8n&n2≥m  
...
Submit
[](https://cracku.in/54-a-contractor-agreed-to-construct-a-6-km-road-in-20-x-cat-2020-slot-3)
Solution   
...
=> n*5x*140=4.5 ...(ii)
(i)/(ii) gives,
(140⋅6x⋅200)(n⋅5x⋅140)=64.5\frac{\left(140\cdot6x\cdot200\right)}{\left(n\cdot5x\cdot140\right)}=\frac{6}{4.5}(n⋅5x⋅140)(140⋅6x⋅200)​=4.56​
=> n=180.
.'. Extra 180-140 =40 workers are needed. 
## Question 55   

If x1=−1x_1=-1x1​=−1 and xm=xm+1+(m+1)x_m=x_{m+1}+(m+1)xm​=xm+1​+(m+1) for every positive integer m, then X100X_{100}X100​ equals
A
-5050
B
-5151
...
D
-5150
[](https://cracku.in/55-if-x_1-1-and-x_mx_m1m1-for-every-positive-integer--x-cat-2020-slot-3)
Solution   

x1=−1x_1=-1x1​=−1
x1=x2+2x_1=x_2+2x1​=x2​+2 => x2=x1−2x_2=x_1-2x2​=x1​−2 = -3
Similarly, 
x3=x1−5=−6x_3=x_1-5=-6x3​=x1​−5=−6
x4=−10x_4=-10x4​=−10
.
.
The series is -1, -3, -6, -10, -15......
When the differences are in AP, then the nth term is −n(n+1)2-\frac{n\left(n+1\right)}{2}−2n(n+1)​
x100=−100(100+1)2=−5050x_{100}=-\frac{100\left(100+1\right)}{2}=-5050x100​=−2100(100+1)​=−5050
## Question 56   

If log⁡a30=A,log⁡a(53)=−B\log_{a}{30}=A,\log_{a}({\frac{5}{3}})=-Bloga​30=A,loga​(35​)=−B and log⁡2a=13\log_2{a}=\frac{1}{3}log2​a=31​, then log⁡3a\log_3{a}log3​a equals
A
...
[](https://cracku.in/56-if-log_a30alog_afrac53-b-and-log_2afrac13-then-log-x-cat-2020-slot-3)
Solution   

log⁡a30=Aorlog⁡a5+log⁡a2+log⁡a3=A\log_a30=A\ or\ \log_a5+\log_a2+\log_a3=Aloga​30=Aorloga​5+loga​2+loga​3=A...........(1)
log⁡a(53)=−Borlog⁡a3−log⁡a5=B\log_a\left(\frac{5}{3}\right)=-B\ or\ \log_a3-\log_a5=Bloga​(35​)=−Borloga​3−loga​5=B.............(2)
and finally log⁡a2=3\log_a2=3loga​2=3
Substituting this in (1) we get log⁡a5+log⁡a3=A−3\log_a5+\log_a3=A-3loga​5+loga​3=A−3
Now we have two equations in two variables (1) and (2) . On solving we get 
log⁡a3=(A+B−3)2orlog⁡3a=2A+B−3\log_a3=\frac{\left(A+B-3\right)}{2\ }or\ \log_3a=\frac{2}{A+B-3}loga​3=2(A+B−3)​orlog3​a=A+B−32​
## Question 57   
...
Submit
[](https://cracku.in/57-dick-is-thrice-as-old-as-tom-and-harry-is-twice-as-x-cat-2020-slot-3)
Solution   
...
D
27
[](https://cracku.in/58-vimla-starts-for-office-every-day-at-9-am-and-reac-x-cat-2020-slot-3)
Solution   

Let distance = d
Given, d35−d40=660\frac{d}{35}-\frac{d}{40}=\frac{6}{60}35d​−40d​=606​
=> d = 28km
...
To reach on time, he should cover remaining 28/3 km in 20 min => Speed = (283)2060=28\frac{\left(\frac{28}{3}\right)}{\frac{20}{60}}=28\ 6020​(328​)​=28 km/hr
## Question 59   

Let m and n be natural numbers such that n is even and 0.2<m20,nm,n11<0.50.2<\frac{m}{20},\frac{n}{m},\frac{n}{11}<0.50.2<20m​,mn​,11n​<0.5. Then m−2nm-2nm−2n equals
A
3
B
1
...
D
4
[](https://cracku.in/59-let-m-and-n-be-natural-numbers-such-that-n-is-even-x-cat-2020-slot-3)
Solution   

0.2<n11<0.50.2<\frac{n}{11}<0.50.2<11n​<0.5
=> 2.2<n<5.5
Since n is an even natural number, the value of n = 4
0.2<m20<0.50.2<\frac{m}{20}<0.50.2<20m​<0.5 => 4< m<10. Possible values of m = 5,6,7,8,9
Since 0.2<nm<0.50.2<\frac{n}{m}<0.50.2<mn​<0.5, the only possible value of m is 9
Hence m-2n = 9-8 = 1
## Question 60   
...
Submit
[](https://cracku.in/60-how-many-integers-in-the-set-100-101-102-999-have--x-cat-2020-slot-3)
Solution   
...
D
399
[](https://cracku.in/61-in-the-final-examination-bishnu-scored-52-and-asha-x-cat-2020-slot-3)
Solution   
...
Submit
[](https://cracku.in/62-if-abc-are-non-zero-and-14a36b84c-then-6bfrac1c-fr-x-cat-2020-slot-3)
Solution   
...
Submit
[](https://cracku.in/63-a-person-invested-a-certain-amount-of-money-at-10--x-cat-2020-slot-3)
Solution   
...
D
31
[](https://cracku.in/64-a-man-buys-35-kg-of-sugar-and-sets-a-marked-price--x-cat-2020-slot-3)
Solution   
...
First 5 kg's are sold at 20% marked up price => SP1=5⋅100⋅1.2SP_1=5\cdot100\cdot1.2SP1​=5⋅100⋅1.2 = Rs 600
Next 15 kgs are sold after giving 10% discount => SP2=15⋅100⋅1.2⋅0.9=1620SP_2=15\cdot100\cdot1.2\cdot0.9\ =\ 1620SP2​=15⋅100⋅1.2⋅0.9=1620
...
=> SP of 1kg = 1805/12 ≃150\simeq\ 150≃150
Hence, the seller should further mark up by (150−120)120⋅100=25%\frac{\left(150-120\right)}{120}\cdot100\ =\ 25\%120(150−120)​⋅100=25%
## Question 65   
...
D
14
[](https://cracku.in/65-the-points-21-and-3-4-are-opposite-vertices-of-a-p-x-cat-2020-slot-3)
Solution   
...
D
10 : 45 am
[](https://cracku.in/66-a-and-b-are-two-railway-stations-90-km-apart-a-tra-x-cat-2020-slot-3)
Solution   
...
Let N, x and y be positive integers such that N=x+y,2<x<10N=x+y,2<x<10N=x+y,2<x<10 and 14<y<2314<y<2314<y<23. If N>25N>25N>25, then how many distinct values are possible for N?
Backspace  
789  
456  
123  
...
Submit
[](https://cracku.in/67-let-n-x-and-y-be-positive-integers-such-that-nxy2l-x-cat-2020-slot-3)
Solution   
...
Let k be a constant. The equations kx+y=3kx + y = 3kx+y=3 and 4x+ky=44x + ky = 44x+ky=4 have a unique solution if and only if
A
∣k∣≠2\mid k\mid\neq2∣k∣​=2
B
∣k∣=2\mid k\mid=2∣k∣=2
...
D
k=2k=2k=2
[](https://cracku.in/68-let-k-be-a-constant-the-equations-kx-y-3-and-4x-ky-x-cat-2020-slot-3)
Solution   

Two linear equations ax+by= c and dx+ ey = f have a unique solution if ad≠be\frac{a}{d}\ne\ \frac{b}{e}da​​=eb​
Therefore, k4≠1k\frac{k}{4}\ne\ \frac{1}{k}4k​​=k1​ => k2≠4k^2\ne\ 4k2​=4
=> k ≠\ne\ ​= |2|
## Question 69   
...
D
43
[](https://cracku.in/69-how-many-of-the-integers-1-2-120-are-divisible-by--x-cat-2020-slot-3)
Solution   
...
D
2020
[](https://cracku.in/70-how-many-pairsa-b-of-positive-integers-are-there-s-x-cat-2020-slot-3)
Solution   

ab=42017=24034ab\ =\ 4^{2017}=2^{4034}ab=42017=24034
...
D
4.2
[](https://cracku.in/71-anil-sunil-and-ravi-run-along-a-circular-path-of-l-x-cat-2020-slot-3)
Solution   

Anil and Sunil will meet at a first point after LCM ( 315,310\frac{3}{15},\frac{3}{10}153​,103​) = 3/5 hr
...
Submit
[](https://cracku.in/72-in-a-trapezium-abcd-ab-is-parallel-to-dc-bc-is-per-x-cat-2020-slot-3)
Solution   
[](https://cracku.in/media/uploads/image_tI0oLQQ.png)
Given, BC = DE = 4
CD = BE = 5
In triangle ADE, EAD=45^{0}$$
tan⁡45=DEAE\tan\ 45\ =\ \frac{DE}{AE}tan45=AEDE​ => AE = 4
Area of trapezium = Area of rectangle BCDE + Area of triangle AED
= 20 + 8 = 28
## Question 73   

The area, in sq. units, enclosed by the lines x=2,y=∣x−2∣+4x=2,y=\mid x-2\mid+4x=2,y=∣x−2∣+4, the X-axis and the Y-axis is equal to
A
10
B
6
...
D
12
[](https://cracku.in/73-the-area-in-sq-units-enclosed-by-the-lines-x2ymid--x-cat-2020-slot-3)
Solution   
[](https://cracku.in/media/uploads/image_0fyXIqx.png)
The required figure is a trapezium with vertices A(0,0), B(2,0), C(2,4) and D(0,6)
AB = 2 BC = 4 and AD = 6
Area of trapezium = 12(sumoftheoppositesides)⋅height\frac{1}{2}\left(sum\ of\ the\ opposite\ sides\right)\cdot height21​(sumoftheoppositesides)⋅height = 12(4+6)⋅2=10\frac{1}{2}\left(4+6\right)\cdot2\ =\ 1021​(4+6)⋅2=10
## Question 74   

If f(x+y)=f(x)f(y)f(x+y)=f(x)f(y)f(x+y)=f(x)f(y) and f(5)=4f(5)=4f(5)=4, then f(10)−f(−10)f(10)-f(-10)f(10)−f(−10) is equal to
A
14.0625
B
0
...
D
3
[](https://cracku.in/74-if-fxyfxfy-and-f54-then-f10-f-10-is-equal-to-x-cat-2020-slot-3)
Solution   

The given function is equivalent to f(x) = axa^xax
Given, f(5) = 4
=> a5=4=>a=415a^5=4=>\ a=4^{\frac{1}{5}}a5=4=>a=451​
=> f(x) = 4x54^{\frac{x}{5}}45x​
f(10) - f(-10) = 16 - 1/16 = 15.9375
## Question 75   

2×4×8×16(log⁡24)2(log⁡48)3(log⁡816)4\frac{2\times4\times8\times16}{(\log_{2}{4})^{2}(\log_{4}{8})^{3}(\log_{8}{16})^{4}}(log2​4)2(log4​8)3(log8​16)42×4×8×16​ equals
Backspace  
789  
456  
123  
...
Submit
[](https://cracku.in/75-frac2times4times8times16log242log483log8164-equals-x-cat-2020-slot-3)
Solution   

2×4×8×16(log⁡24)2(log⁡48)3(log⁡816)4\frac{2\times4\times8\times16}{(\log_{2}{4})^{2}(\log_{4}{8})^{3}(\log_{8}{16})^{4}}(log2​4)2(log4​8)3(log8​16)42×4×8×16​
= 21×22×23×24(log⁡222)2(log⁡2223)3(log⁡2324)4\frac{2^1\times2^2\times2^3\times2^4}{(\log_22^2)^2(\log_{2^2}2^3)^3(\log_{2^3}2^4)^4}(log2​22)2(log22​23)3(log23​24)421×22×23×24​
= 21+2+3+4(2)2(32)3(32)4\frac{2^{1+2+3+4}}{(2)^2(\frac{3}{2})^3(\frac{3}{2})^4}(2)2(23​)3(23​)421+2+3+4​
= 2104(32)3(43)4=24\frac{2^{10}}{4\left(\frac{3}{2}\right)^3\left(\frac{4}{3}\right)^4}=244(23​)3(34​)4210​=24
## Question 76   
...
[](https://cracku.in/76-the-vertices-of-a-triangle-are-00-40-and-39-the-ar-x-cat-2020-slot-3)
Solution   

Equation of circle x2+y2+2gx+2fy+c=0x^2+y^2+2gx+2fy+c=0x2+y2+2gx+2fy+c=0
...
Therefore, Area = πr2=205π9\pi\ r^2=\frac{205\pi\ }{9}πr2=9205π​
