...
D
7:5
[](https://cracku.in/51-the-distance-from-b-to-c-is-thrice-that-from-a-to--x-cat-2020-slot-2)
Solution   
...
Ratio of time taken = 5272=57\frac{5}{\frac{2}{\frac{7}{2}}}=\frac{5}{7}27​2​5​=75​
## Question 52   
...
Submit
[](https://cracku.in/52-john-takes-twice-as-much-time-as-jack-to-finish-a--x-cat-2020-slot-2)
Solution   
...
Now let Jim take "m" days to complete the work. According to question, 1t+1m=32tor1m=12torm=2t\frac{1}{t}+\frac{1}{m}=\frac{3}{2t}\ or\ \frac{1}{m}=\frac{1}{2t\ }or\ m=2tt1​+m1​=2t3​orm1​=2t1​orm=2t Hence Jim takes "2t" time to complete the work.
Now let the three of them complete the work in "p" days. Hence John takes "p+3" days to complete the work.
12t(m+3)=(42t)m\frac{1}{2t}\left(m+3\right)=\left(\frac{4}{2t}\right)m2t1​(m+3)=(2t4​)m
12t(m+3)=(42t)m\frac{1}{2t}\left(m+3\right)=\left(\frac{4}{2t}\right)m2t1​(m+3)=(2t4​)m
...
f(x)=x2+ax+bf\left(x\right)=\ x^2+ax+bf(x)=x2+ax+b
f(x+1)=x2+2x+1+ax+a+bf\left(x+1\right)=x^2+2x+1+ax+a+bf(x+1)=x2+2x+1+ax+a+b
f(x−1)=x2−2x+1+ax−a+bf\left(x-1\right)=x^2-2x+1+ax-a+bf(x−1)=x2−2x+1+ax−a+b
g(x)=f(x+1)−f(x−1)=4x+2a g(x)=f(x+1)-f(x-1)= 4x+2ag(x)=f(x+1)−f(x−1)=4x+2a
Now g(20)=72g(20) = 72g(20)=72 from this we get a=−4a = -4a=−4 ; f(x)=x2−4x+bf\left(x\right)=x^2-4x\ +bf(x)=x2−4x+b
For this expression to be greater than zero it has to be a perfect square which is possible for b≥4b\ge\ 4b≥4
...
Submit
[](https://cracku.in/54-for-the-same-principal-amount-the-compound-interes-x-cat-2020-slot-2)
Solution   

For two years the compound interest is PR(1)100+PR(1)100(1+PR(1)100)\frac{PR(1)}{100}+\frac{PR(1)}{100}\left(1+\frac{PR(1)}{100}\right)100PR(1)​+100PR(1)​(1+100PR(1)​)
...
D
7.2
[](https://cracku.in/55-let-c-be-a-circle-of-radius-5-meters-having-center-x-cat-2020-slot-2)
Solution   

We can form the following figure based on the given information:
[](https://cracku.in/media/uploads/image_vOZ14ax.png)
Since OA = 4 m and OB=3 m; AB = 5 m. OR bisects the chord into PC and QC. 
Since AB = 5 m, we have a+b=5...(i)a+b = 5 ...(i)a+b=5...(i) Also, 42−k2=a2...(ii)4^2\ -k^2=a^2...\left(ii\right)42−k2=a2...(ii) and 32−k2=b2...(iii)3^2\ -k^2=b^2...\left(iii\right)32−k2=b2...(iii)
Subtracting (iii) from (ii), we get: a2−b2=7...(iv)a^2\ -b^2=7...\left(iv\right)a2−b2=7...(iv)
Substituting (i) in (iv), we get a−b=1.4...(v)a - b = 1.4 ...(v)a−b=1.4...(v); [(a+b)(a−b)=7;∴(a−b)=75]\left[\left(a+b\right)\left(a\ -b\right)=7;\ \therefore\ \left(a-b\right)=\frac{7}{5}\right][(a+b)(a−b)=7;∴(a−b)=57​]
Solving (i) and (v), we obtain the value of a=3.2a=3.2a=3.2 and b=1.8b=1.8b=1.8
Hence, k2=5.76k^2\ =\ 5.76k2=5.76
Moving on to the larger triangle △POC\triangle\ POC△POC, we have 52−k2=(x+a)25^2-k^2=\left(x+a\right)^252−k2=(x+a)2; 
Substituting the previous values, we get: (25−5.76)=(x+3.2)2(25-5.76)=\left(x+3.2\right)^2(25−5.76)=(x+3.2)2
19.24=(x+3.2)\sqrt{19.24}=\left(x+3.2\right)19.24​=(x+3.2) or x=1.19mx = 1.19 mx=1.19m
Similarly, solving for y using △QOC\triangle\ QOC△QOC, we get y=2.59my=2.59 my=2.59m
Therefore, PQ=5+2.59+1.19=8.78≈8.8mPQ = 5+2.59+1.19 = 8.78 \approx\ 8.8 mPQ=5+2.59+1.19=8.78≈8.8m
...
D
550
[](https://cracku.in/56-in-a-car-race-car-a-beats-car-b-by-45-km-car-b-bea-x-cat-2020-slot-2)
Solution   
...
Submit
[](https://cracku.in/57-how-many-4-digit-numbers-each-greater-than-1000-an-x-cat-2020-slot-2)
Solution   
...
D
18
[](https://cracku.in/58-the-sum-of-the-perimeters-of-an-equilateral-triang-x-cat-2020-slot-2)
Solution   
...
Moreover area of the equilateral triangle is 34m2\frac{\sqrt{\ 3}}{4}m^243​​m2 and area of the rectangle is 3a23a^23a2
According to the relation given (34m2)2=3a2\left(\frac{\sqrt{\ 3}}{4}m^2\right)^{^2}=\ 3a^2(43​​m2)2=3a2
316m4=3a2ora2=m416\frac{3}{16}m^4=\ 3a^2\ or\ a^2=\frac{m^4}{16}163​m4=3a2ora2=16m4​
a=m24a=\frac{m^2}{4}a=4m2​
Substituting this in (1) we get 2m2+3m−90=02m^2+3m-90\ =02m2+3m−90=0 solving this we get m=6 (ignoring the negative value since side can't be negative)
...
Submit
[](https://cracku.in/59-a-sum-of-money-is-split-among-amal-sunil-and-mita--x-cat-2020-slot-2)
Solution   
...
The value of log⁡a(ab)+log⁡b(ba)\log_{a}({\frac{a}{b}})+\log_{b}({\frac{b}{a}})loga​(ba​)+logb​(ab​), for 1<a≤b1<a\leq b1<a≤b cannot be equal to
A
0
B
-1
...
D
-0.5
[](https://cracku.in/60-the-value-of-logafracablogbfracba-for-1ltaleq-b-ca-x-cat-2020-slot-2)
Solution   

On expanding the expression we get 1−log⁡ab+1−log⁡ba1-\log_ab+1-\log_ba1−loga​b+1−logb​a
or2−(log⁡ab+1log⁡ab)or\ 2-\left(\log_ab+\frac{1}{\log_ab}\right)or2−(loga​b+loga​b1​)
Now applying the property of AM>=GM, we get that (log⁡ab+1log⁡ab)2≥1or(log⁡ab+1log⁡ab)≥2\frac{\left(\log_ab+\frac{1}{\log_ab}\right)}{2}\ge1\ or\ \left(\log_ab+\frac{1}{\log_ab}\right)\ge22(loga​b+loga​b1​)​≥1or(loga​b+loga​b1​)≥2 Hence from here we can conclude that the expression will always be equal to 0 or less than 0. Hence any positive value is not possible. So 1 is not possible.
## Question 61   
...
D
19
[](https://cracku.in/61-students-in-a-college-have-to-choose-at-least-two--x-cat-2020-slot-2)
Solution   
...
D
6
[](https://cracku.in/62-in-a-group-of-10-students-the-mean-of-the-lowest-9-x-cat-2020-slot-2)
Solution   
...
D
222\sqrt{2}22​
[](https://cracku.in/63-a-and-b-are-two-points-on-a-straight-line-ram-runs-x-cat-2020-slot-2)
Solution   
...
Dividing both the equations we get v(r)4v(h)=v(h)v(r)orv(r)v(h)=2\frac{v\left(r\right)}{4v\left(h\right)}=\frac{v\left(h\right)}{v\left(r\right)}\ or\ \frac{v\left(r\right)}{v\left(h\right)}=24v(h)v(r)​=v(r)v(h)​orv(h)v(r)​=2 Hence the ratio is 2.
## Question 64   
...
D
4
[](https://cracku.in/64-two-circular-tracks-t1-and-t2-of-radii-100-m-and-2-x-cat-2020-slot-2)
Solution   
[](https://cracku.in/media/uploads/image_lmGqNsE.png)
...
Submit
[](https://cracku.in/65-let-c1-and-c2-be-concentric-circles-such-that-the--x-cat-2020-slot-2)
Solution   
...
Hence (r+1)2=r2+9\left(r+1\right)^2=r^2+9(r+1)2=r2+9 or r2+1+2r=r2+9or2r=8orr=4cmr^{2\ }+1+2r\ =\ r^2+9\ or\ 2r=8\ or\ r=4cmr2+1+2r=r2+9or2r=8orr=4cm
Hence the radius of the larger circle is 5cm and diameter is 10cm.
[](https://cracku.in/media/uploads/paint_CBuPEfp.png)
## Question 66   
...
D
55
[](https://cracku.in/66-anil-buys-12-toys-and-labels-each-with-the-same-se-x-cat-2020-slot-2)
Solution   
...
D
5
[](https://cracku.in/67-the-number-of-integers-that-satisfy-the-equality-x-x-cat-2020-slot-2)
Solution   

(x2−5x+7)x+1=1\left(x^2-5x+7\right)^{x+1}=1(x2−5x+7)x+1=1
There can be a solution when (x2−5x+7)=1\left(x^2-5x+7\right)=1(x2−5x+7)=1 or x2−5x+6=0x^2-5x\ +6=0x2−5x+6=0
or x=3 and x=2
...
Submit
[](https://cracku.in/68-the-number-of-pairs-of-integers-xy-satisfying-xgeq-x-cat-2020-slot-2)
Solution   

We have 2x + 5y = 99 or x=(99−5y)2x=\frac{\left(99-5y\right)}{2}x=2(99−5y)​
Now x≥y≥−20x\ge\ y\ \ge\ -20x≥y≥−20 ; So (99−5y)2≥y;99≥7yory≤≈14\frac{\left(99-5y\right)}{2}\ge\ y\ ;\ 99\ge7y\ or\ y\le\ \approx\ 142(99−5y)​≥y;99≥7yory≤≈14
So −20≤y≤14-20\le y\le14−20≤y≤14. Now for this range of "y", we have to find all the integral values of "x". As the coefficient of "x" is 2,
...
A
3s22\frac{\sqrt{3}s^{2}}{2}23​s2​
B
2s23\frac{2s^{2}}{\sqrt{3}}3​2s2​
C
s223\frac{s^{2}}{2\sqrt{3}}23​s2​
D
s23\frac{s^{2}}{\sqrt{3}}3​s2​
[](https://cracku.in/69-from-an-interior-point-of-an-equilateral-triangle--x-cat-2020-slot-2)
Solution   
[](https://cracku.in/media/uploads/Screenshot_TPSJW1B.png)
...
12×GD×a+12×GE×a+12×GF×a=34a2\frac{1}{2}\times\ GD\times\ a+\ \frac{1}{2}\times\ GE\times\ a\ +\frac{1}{2}\times\ GF\times\ a=\frac{\sqrt{\ 3}}{4}a^221​×GD×a+21​×GE×a+21​×GF×a=43​​a2
Now GD+GE+GF=3a2GD+GE+GF=\frac{\sqrt{\ 3}a}{2}GD+GE+GF=23​a​ or s=3a2ora=2s3s=\frac{\sqrt{\ 3}a}{2}\ or\ a=\frac{2s}{\sqrt{\ 3}}s=23​a​ora=3​2s​
Given the area of the equilateral triangle = 34a2\ \frac{\sqrt{3}}{4}a^2\ 43​​a2 ; substituting the value of 'a' from above, we get the area {in terms 's'}= s23\frac{s^2}{\sqrt{3}}3​s2​
## Question 70   

Let the m-th and n-th terms of a geometric progression be 34\frac{3}{4}43​ and 12. respectively, where m<nm < nm<n. If the common ratio of the progression is an integer r, then the smallest possible value of r+n−mr + n - mr+n−m is
A
6
B
2
...
D
-2
[](https://cracku.in/70-let-the-m-th-and-n-th-terms-of-a-geometric-progres-x-cat-2020-slot-2)
Solution   

Let the first term of the GP be "a" . Now from the question we can show that
arm−1=34ar^{m-1}=\frac{3}{4}arm−1=43​ arn−1=12ar^{n-1}=12arn−1=12
Dividing both the equations we get rm−1−n+1=116orrm−n=16−1orrn−m=16r^{m-1-n+1}=\frac{1}{16}\ or\ r^{m-n}=16^{-1\ }or\ r^{n-m}=16rm−1−n+1=161​orrm−n=16−1orrn−m=16
...
D
Rs.580
[](https://cracku.in/71-in-may-john-bought-the-same-amount-of-rice-and-the-x-cat-2020-slot-2)
Solution   
...
If x and y are non-negative integers such that x+9=zx + 9 = zx+9=z, y+1=zy + 1 = zy+1=z and x+y<z+5x + y < z + 5x+y<z+5, then the maximum possible value of 2x+y2x + y2x+y equals
Backspace  
789  
456  
123  
...
Submit
[](https://cracku.in/72-if-x-and-y-are-non-negative-integers-such-that-x-9-x-cat-2020-slot-2)
Solution   
...
D
36
[](https://cracku.in/73-aron-bought-some-pencils-and-sharpeners-spending-t-x-cat-2020-slot-2)
Solution   
...
[](https://cracku.in/74-for-real-x-the-maximum-possible-value-of-fracxsqrt-x-cat-2020-slot-2)
Solution   

Now x1+x4=11+x4x2=11x2+x2\frac{x}{\sqrt{\ 1+x^4}}=\ \frac{\ 1}{\sqrt{\ \ \frac{\ 1+x^4}{x^2}}}=\frac{1}{\sqrt{\ \frac{1}{x^2}+x^2}}1+x4​x​=x21+x4​​1​=x21​+x2​1​
Applying A.M>= G.M.
(1x2+x2)2≥1or1x2+x2≥2\frac{\left(\frac{1}{x^2}+x^2\right)}{2}\ge\ 1\ or\ \ \frac{1}{x^2}+x^2\ge\ 22(x21​+x2)​≥1orx21​+x2≥2 Substituting we get the maximum possible value of the equation as 12\frac{1}{\sqrt{\ 2}}2​1​
## Question 75   
...
D
7
[](https://cracku.in/75-in-how-many-ways-can-a-pair-of-integers-x-a-be-cho-x-cat-2020-slot-2)
Solution   

x2−2∣x∣+∣a−2∣=0x^{2}-2\mid x\mid+\mid a-2\mid=0x2−2∣x∣+∣a−2∣=0
where x>= 0 and x>=2
x2−2x+a−2=0x^2-2x+a-2\ =0x2−2x+a−2=0 Using quadratic equation we have x=1+3−aandx=1−3−ax=\ 1+\sqrt{\ 3-a}\ and\ x=1-\sqrt{\ 3-a}x=1+3−a​andx=1−3−a​ Only two integer values are possible
...
Submit
[](https://cracku.in/76-if-x-and-y-are-positive-real-numbers-satisfying-xy-x-cat-2020-slot-2)
Solution   

Now we have 2601(1+1x)(1+1y)=2601(xy+y+x+1xy)2601\left(1+\frac{1}{x}\right)\left(1+\frac{1}{y}\right)=2601\left(\frac{xy+y+x+1}{xy}\right)2601(1+x1​)(1+y1​)=2601(xyxy+y+x+1​)
Now we know that x+y=102. Substituting it in the above equation
2601(xy+y+x+1xy)=2601(103xy+1)2601\left(\frac{xy+y+x+1}{xy}\right)=2601\left(\frac{103}{xy}+1\right)2601(xyxy+y+x+1​)=2601(xy103​+1)
Maximum value of xy can be found out by AM>= GM relationship
x+y2≥xyorxy≤51orxy≤2601\ \frac{\ x+y}{2}\ge\ \sqrt{xy}\ or\ \ \sqrt{\ xy}\le\ 51\ or\ xy\le\ 26012x+y​≥xy​orxy​≤51orxy≤2601
Hence the maximum value of "xy" is 2601. Substituting in the above equation we get
2601(103+26012601)=27042601\left(\ \frac{\ 103+2601}{2601}\right)=27042601(2601103+2601​)=2704
